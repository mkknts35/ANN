...
//   Date:          April 7, 2016
//   Description:   Class definition of layer. This class is a part of an 
//                  artificial neural network implementation. It works in 
//                  combination with a derivative of the virtual class neuron,
//                  and provides some abstract structure to the network.
//============================================================================
#pragma once
#ifndef LAYER_H
#define LAYER_H
...
{
private:
    vector<shared_ptr<neuron>> m_layer;
