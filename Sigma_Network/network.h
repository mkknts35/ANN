...
//                  conjunction with two other classes: layer and a derivative
//                  of neuron (such as sigmoid). The only one of these two 
//                  classes that this class interacts with directly is the 
//                  layer class, because the network consists of a series of 
//                  layers.
//============================================================================
#pragma once
#ifndef NETWORK_H
